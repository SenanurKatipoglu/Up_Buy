...
public class AntikaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerV=findViewById(R.id.recycleV); // recycleView tanımlanır.
        LinearLayoutManager layoutManager= new LinearLayoutManager(this); // nasıl listelenmesi gerektiğini söylüyoruz
    ...
    //  firebaseden veri çekmek için oluşturulmuştur.
    private void GetDataFromFirebase(){
        Query query=mReference.child("Kategori").child("03").child("Ürün");
